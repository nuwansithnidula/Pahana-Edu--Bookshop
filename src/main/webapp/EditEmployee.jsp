...
<%@ page import="com.edups.model.Employee" %>
<%
...
<html>
<head>
    <title>Edit Employee - PahanaEdu-Book-Shop</title>
    <style>
        body {
            margin: 0;
    ...
    <script>
        function validateForm(event) {
            ...
            setErr("errName"); setErr("errEmail"); setErr("errPassword");
...
%>
    <div class="empty">
        <strong>Error:</strong> Employee data not found. Please go back to the list and try again.
...
<div class="container">
    ...
    <form method="post" action="<%= ctx %>/EmployeeServlet" onsubmit="validateForm(event)">
        ...
        <input type="text" id="id" name="id" value="<%= emp.getId() %>" readonly>
        <span class="field-hint">Employee ID cannot be changed.</span>
        ...
        <input type="text" id="password" name="password" value="<%= emp.getPassword() %>" required>
